defmodule BangersAndMash.WebUI.Test do
  ...
  def module_string(test) do
    """
    defmodule BangersAndMash.Browser.#{name_to_mod(test.name)} do
      use Hound.Helpers
  ...
  defp tests_dir do
    Application.get_env(:bangers_and_mash, :browser_test_directory) || "priv/browser/tests/"
  end

  defp storage_mod do
    Application.get_env(:bangers_and_mash, :persist_strategy)
  end
end
